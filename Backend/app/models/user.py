from sqlalchemy import String, Boolean, ForeignKey, Enum, Date
...
class User(Base):
    ...
    cognito_sub: Mapped[Optional[str]] = mapped_column(String(255), unique=True, nullable=True, index=True)  # ← AGREGADO
